...
class Ui_Login(object):
    def setupUi(self, Login):
        ...
        self.pshbtn_exit = QtWidgets.QPushButton(self.wdgt_input)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pshbtn_exit.sizePolicy().hasHeightForWidth())
        self.pshbtn_exit.setSizePolicy(sizePolicy)
        self.pshbtn_exit.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pshbtn_exit.setObjectName("pshbtn_exit")
        self.wdgt_input_layout.addWidget(self.pshbtn_exit)
        ...
        self.wdgt_input_layout.setStretch(5, 1)
